...
if(BUILD_CLIENT)
	...
	if(FEATURE_JANSSON)
		...
		set(CLIENT_SRC ${CLIENT_SRC} "src/qcommon/json.cpp")
	else(FEATURE_JANSSON)
		set(CLIENT_SRC ${CLIENT_SRC} "src/qcommon/json_stubs.cpp")
...
if(BUILD_CLIENT OR BUILD_SERVER)
	if(FEATURE_CURL)
		...
		set(CLIENT_SRC ${CLIENT_SRC} "src/qcommon/dl_main_curl.cpp")
		set(SERVER_SRC ${SERVER_SRC} "src/qcommon/dl_main_curl.cpp")
	else(FEATURE_CURL)
		set(CLIENT_SRC ${CLIENT_SRC} "src/qcommon/dl_main_stubs.cpp")
		set(SERVER_SRC ${SERVER_SRC} "src/qcommon/dl_main_stubs.cpp")
	endif(FEATURE_CURL)
