...
void R_Register(void)
{
	...
	r_specularExponent  = ri.Cvar_Get("r_specularExponent", "8.0", CVAR_CHEAT | CVAR_LATCH);
	r_specularExponent2 = ri.Cvar_Get("r_specularExponent2", "8.0", CVAR_CHEAT | CVAR_LATCH);
	//this one sets the power of specular, the higher the brighter
	r_specularScale      = ri.Cvar_Get("r_specularScale", "0.25", CVAR_CHEAT | CVAR_LATCH);
