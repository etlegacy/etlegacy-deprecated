                     ...
                     qboolean noCompress)
{
	...
	{
		resampledBuffer = (unsigned int *)R_GetImageBuffer(scaled_width * scaled_height * 4, BUFFER_RESAMPLED, "resample");
	...
	scaledBuffer = (unsigned int *)R_GetImageBuffer(sizeof(unsigned) * scaled_width * scaled_height, BUFFER_SCALED, "resample");
