...
weapon_t BG_FindClipForWeapon(weapon_t weapon)
{
	...
	return (weapon_t)weaponTable[weapon].clipIndex;
}

weapon_t BG_FindAmmoForWeapon(weapon_t weapon)
{
	// FIXME: check valid weapon?
	return (weapon_t)weaponTable[weapon].ammoIndex;
}
...
qboolean BG_AddMagicAmmo(playerState_t *ps, int *skill, int teamNum, int numOfClips)
{
	...
	int weapon = BG_GrenadeTypeForTeam((team_t)teamNum);
	int clip   = BG_FindClipForWeapon((weapon_t)weapon);
