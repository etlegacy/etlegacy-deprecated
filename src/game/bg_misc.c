...
weaponTable_t weaponTable[WP_NUM_WEAPONS] =
{
	...
	{ WP_COLT,                 ITEM_WEAPON_COLT,                  TEAM_ALLIES, SK_LIGHT_WEAPONS,                            WP_SILENCED_COLT,       WP_LUGER,                WP_NONE,  WP_COLT,              WP_COLT,              18,    0,           600,   0.4f,       0,           0,           WEAPON_TYPE_PISTOL,                        WEAPON_FIRING_MODE_SEMI_AUTOMATIC,                           WEAPON_ATTRIBUT_FAST_RELOAD | WEAPON_ATTRIBUT_FALL_OFF,                                                                                                      0,      0,     "COLT",                WS_COLT,            qtrue,  qtrue,  24,     1,   8,      1500,      DELAY_PISTOL,  400,         0,          20,               0,      0,       0,               250,            250,             0,                 0,                  0,        { 14, 6, -4 },    100,               { .45f, .15f }, { 0, 0 },      "",                "colt",                  WEAP_IDLE1, WEAP_ATTACK1, WEAP_ATTACK_LASTSHOT, WEAP_ALTSWITCHFROM, WEAP_ALTSWITCHTO,   WEAP_RELOAD1, WEAP_RAISE,   WEAP_DROP,    {1, 1, 1, 1, 1},                     MOD_COLT,                 MOD_COLT                 },  // WP_COLT                  // 7    // equivalent american weapon to german luger
