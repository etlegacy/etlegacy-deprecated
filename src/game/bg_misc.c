...
{
	// weapon                  item                               team         skillBased                                   weapAlts                weapEquiv          akimboSidearm   ammoIndex             clipIndex             damage damageScope  spread spreadScale splashDamage splashRadius type                                          firingMode                                                   attributes                                                                                                                                                   zoomOut zoomIn desc                   indexWeaponStat     useAmmo useClip maxAmmo uses maxClip reloadTime firstDelayTime nextShotTime grenadeTime aimSpreadScaleAdd maxHeat coolRate heatRecoveryTime switchTimeBegin switchTimeFinish altSwitchFromTime altSwitchToTime knockback muzzlePointOffset weapRecoilDuration weapRecoilPitch weapRecoilYaw  className          weapFile                 chargeTimeCoeff                      mod                       splashMod
	{ WP_NONE,                 ITEM_NONE,                         TEAM_FREE,   SK_NUM_SKILLS,                               WP_NONE,                WP_NONE,                 WP_NONE,  WP_NONE,              WP_NONE,              1,     0,           0,     0,          0,           0,           WEAPON_TYPE_NONE,                             WEAPON_FIRING_MODE_NONE,                                     WEAPON_ATTRIBUT_KEEP_DESGUISE | WEAPON_ATTRIBUT_NEVER_LOST_DESGUISE,                                                                                         0,      0,     "WP_NONE",             WS_MAX,             qfalse, qfalse, 0,      0,   0,      0,         50,            0,           0,          0,                0,      0,       0,               250,            250,             250,              250,            0,        { 0, 0, 0 },      0,                 { 0, 0 },       { 0, 0 },      "",                NULL,                    {1, 1, 1, 1, 1},                     MOD_UNKNOWN,              MOD_UNKNOWN              },  // WP_NONE                  // 0
	...
	{ WP_PANZERFAUST,          ITEM_WEAPON_PANZERFAUST,           TEAM_AXIS,   SK_HEAVY_WEAPONS,                            WP_NONE,                WP_BAZOOKA,              WP_NONE,  WP_PANZERFAUST,       WP_PANZERFAUST,       400,   0,           0,     0,          400,         300,         WEAPON_TYPE_PANZER,                           WEAPON_FIRING_MODE_ONE_SHOT,                                 WEAPON_ATTRIBUT_CHARGE_TIME | WEAPON_ATTRIBUT_SHAKE,                                                                                                         0,      0,     "PANZERFAUST",         WS_PANZERFAUST,     qtrue,  qfalse, 4,      1,   1,      0,         DELAY_HW,      2000,        0,          0,                0,      0,       0,               250,            250,             250,              250,            32000.f,  { 14, 10, 0 },    0,                 { 0, 0 },       { 0, 0 },      "rocket",          "panzerfaust",           {1, .66f, .66f, .66f, .66f},         MOD_PANZERFAUST,          MOD_PANZERFAUST          },  // WP_PANZERFAUST           // 5    // updated delay so prediction is correct
	{ WP_FLAMETHROWER,         ITEM_WEAPON_FLAMETHROWER,          TEAM_FREE,   SK_HEAVY_WEAPONS,                            WP_NONE,                WP_NONE,                 WP_NONE,  WP_FLAMETHROWER,      WP_FLAMETHROWER,      5,     0,           0,     0,          5,           5,           WEAPON_TYPE_NONE,                             WEAPON_FIRING_MODE_NONE,                                     WEAPON_ATTRIBUT_NONE,                                                                                                                                        0,      0,     "FLAMETHROWER",        WS_FLAMETHROWER,    qtrue,  qfalse, 200,    1,   200,    0,         DELAY_LOW,     50,          0,          0,                0,      0,       0,               250,            250,             250,              250,            2000.f,   { 14, 6, -4 },    0,                 { 0, 0 },       { 0, 0 },      "flamechunk",      "flamethrower",          {1, 1, 1, 1, 1},                     MOD_FLAMETHROWER,         MOD_FLAMETHROWER         },  // WP_FLAMETHROWER          // 6
	...
	//                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         
	{ WP_GPG40,                ITEM_WEAPON_GPG40,                 TEAM_AXIS,   SK_EXPLOSIVES_AND_CONSTRUCTION,              WP_KAR98,               WP_NONE,                 WP_NONE,  WP_GPG40,             WP_GPG40,             0,     0,           0,     0,          250,         250,         WEAPON_TYPE_RIFLENADE,                        WEAPON_FIRING_MODE_ONE_SHOT,                                 WEAPON_ATTRIBUT_CHARGE_TIME,                                                                                                                                 0,      0,     "",                    WS_GRENADELAUNCHER, qtrue,  qfalse, 4,      1,   1,      0,         DELAY_LOW,     400,         0,          0,                0,      0,       0,               250,            250,             1347,             2350,           0,        { 14, 6, -4 },    0,                 { 0, 0 },       { 0, 0 },      "gpg40_grenade",   "gpg40",                 {.5f, .5f, .5f, .5f, .5f},           MOD_GPG40,                MOD_GPG40                },  // WP_GPG40                 // 36
	{ WP_M7,                   ITEM_WEAPON_M7,                    TEAM_ALLIES, SK_EXPLOSIVES_AND_CONSTRUCTION,              WP_CARBINE,             WP_NONE,                 WP_NONE,  WP_M7,                WP_M7,                0,     0,           0,     0,          250,         250,         WEAPON_TYPE_RIFLENADE,                        WEAPON_FIRING_MODE_ONE_SHOT,                                 WEAPON_ATTRIBUT_CHARGE_TIME,                                                                                                                                 0,      0,     "",                    WS_GRENADELAUNCHER, qtrue,  qfalse, 4,      1,   1,      0,         DELAY_LOW,     400,         0,          0,                0,      0,       0,               250,            250,             1347,             2350,           0,        { 14, 6, -4 },    0,                 { 0, 0 },       { 0, 0 },      "m7_grenade",      "m7",                    {.5f, .5f, .5f, .5f, .5f},           MOD_M7,                   MOD_M7                   },  // WP_M7                    // 37
	//                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         
