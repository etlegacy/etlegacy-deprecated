	...
	if (g_knifeonly.integer != 1)
	{
		...
		case TEAM_AXIS:
			...
			case PC_SOLDIER:
				...
				{
					client->ps.ammoclip[BG_FindClipForWeapon((weapon_t)weaponTable[WP_AKIMBO_LUGER].akimboSideram)] = GetAmmoTableData(WP_AKIMBO_LUGER)->defaultStartingClip;
			...
			case PC_COVERTOPS:
				...
				{
					client->ps.ammoclip[BG_FindClipForWeapon((weapon_t)weaponTable[WP_AKIMBO_SILENCEDLUGER].akimboSideram)] = GetAmmoTableData(WP_AKIMBO_SILENCEDLUGER)->defaultStartingClip;
		...
		default:
			...
			case PC_SOLDIER:
				...
				{
					client->ps.ammoclip[BG_FindClipForWeapon((weapon_t)weaponTable[WP_AKIMBO_COLT].akimboSideram)] = GetAmmoTableData(WP_AKIMBO_COLT)->defaultStartingClip;
			...
			case PC_COVERTOPS:
				...
				{
					client->ps.ammoclip[BG_FindClipForWeapon((weapon_t)weaponTable[WP_AKIMBO_SILENCEDCOLT].akimboSideram)] = GetAmmoTableData(WP_AKIMBO_SILENCEDCOLT)->defaultStartingClip;
