	...
	{
		{
			...
			{ WP_KNIFE,                SK_LIGHT_WEAPONS,                            0, 1,   0,   INV_NONE     },
			{
				{ WP_MP40,                 SK_LIGHT_WEAPONS,                            0, 60,  30,  INV_NONE     }, // soldier start with x2 ammo
				{ WP_MOBILE_MG42,          SK_HEAVY_WEAPONS,                            0, 0,   150, INV_NONE     },
				{ WP_FLAMETHROWER,         SK_HEAVY_WEAPONS,                            0, 200, 1,   INV_NONE     },
				{ WP_PANZERFAUST,          SK_HEAVY_WEAPONS,                            0, 4,   0,   INV_NONE     },
				{ WP_MORTAR2,              SK_HEAVY_WEAPONS,                            0, 15,  0,   INV_NONE     },
			},
			{
				{ WP_LUGER,                SK_LIGHT_WEAPONS,                            0, 24,  8,   INV_NONE     },
				{ WP_AKIMBO_LUGER,         SK_LIGHT_WEAPONS,                            4, 48,  8,   INV_NONE     },
				{ WP_MP40,                 SK_HEAVY_WEAPONS,                            4, 60,  30,  INV_NONE     }, // soldier start with x2 ammo
			},
			{ WP_GRENADE_LAUNCHER,     SK_LIGHT_WEAPONS,                            0, 4,   0,   INV_NONE     },
			{
				{ WP_BINOCULARS,           SK_BATTLE_SENSE,                             1, 1,   0,   INV_BINOCS   },
			},
			0,
			0,
		},

		{
			...
			{ WP_KNIFE,                SK_LIGHT_WEAPONS,                            0, 1,   0,   INV_NONE     },
			{
				{ WP_MP40,                 SK_LIGHT_WEAPONS,                            0, 0,   30,  INV_NONE     }, // medic start with 1 clip less
			},
			{
				{ WP_LUGER,                SK_LIGHT_WEAPONS,                            0, 24,  8,   INV_NONE     },
				{ WP_AKIMBO_LUGER,         SK_LIGHT_WEAPONS,                            4, 48,  8,   INV_NONE     },
			},
			{ WP_GRENADE_LAUNCHER,     SK_LIGHT_WEAPONS,                            0, 1,   0,   INV_NONE     },
			{
				{ WP_MEDIC_SYRINGE,        SK_FIRST_AID,                                0, 10,  1,   INV_NONE     },
				{ WP_MEDIC_ADRENALINE,     SK_FIRST_AID,                                4, 0,   1,   INV_NONE     }, // share ammo with medic syringe
				{ WP_MEDKIT,               SK_FIRST_AID,                                0, 0,   1,   INV_NONE     },
				{ WP_BINOCULARS,           SK_BATTLE_SENSE,                             1, 1,   0,   INV_BINOCS   },
			},
			0,
			0,
...

		{
			...
			{ WP_KNIFE,                SK_LIGHT_WEAPONS,                            0, 1,   0,   INV_NONE     },
			{
				{ WP_MP40,                 SK_LIGHT_WEAPONS,                            0, 30,  30,  INV_NONE     },
				{ WP_KAR98,                SK_LIGHT_WEAPONS,                            0, 20,  10,  INV_NONE     },
			},
			{
				{ WP_LUGER,                SK_LIGHT_WEAPONS,                            0, 24,  8,   INV_NONE     },
				{ WP_AKIMBO_LUGER,         SK_LIGHT_WEAPONS,                            4, 48,  8,   INV_NONE     },
			...
			{ WP_GRENADE_LAUNCHER,     SK_LIGHT_WEAPONS,                            0, 4,   0,   INV_NONE     },
			{
				{ WP_GPG40,                SK_EXPLOSIVES_AND_CONSTRUCTION,              0, 4,   0,   INV_NONE     }, // riflenade as special weapon
				{ WP_DYNAMITE,             SK_EXPLOSIVES_AND_CONSTRUCTION,              0, 0,   1,   INV_NONE     },
				{ WP_PLIERS,               SK_EXPLOSIVES_AND_CONSTRUCTION,              0, 0,   1,   INV_NONE     },
				{ WP_LANDMINE,             SK_EXPLOSIVES_AND_CONSTRUCTION,              0, 0,   1,   INV_NONE     },
				{ WP_BINOCULARS,           SK_BATTLE_SENSE,                             1, 1,   0,   INV_BINOCS   },
			},
			0,
			0,
...

		{
			...
			{ WP_GRENADE_LAUNCHER,     SK_LIGHT_WEAPONS,                            0, 1,   0,   INV_NONE     },
			{
				{ WP_AMMO,                 SK_SIGNALS,                                  0, 0,   1,   INV_NONE     },
				{ WP_SMOKE_MARKER,         SK_SIGNALS,                                  0, 0,   1,   INV_NONE     },
				{ WP_BINOCULARS,           SK_BATTLE_SENSE,                             0, 0,   1,   INV_BINOCS   },
			},
			0,
			0,
		},

		{
			...
			{ WP_KNIFE,                SK_LIGHT_WEAPONS,                            0, 1,   0,   INV_NONE     },
			{
				{ WP_MP34,                 SK_LIGHT_WEAPONS,                            0, 64,  32,  INV_NONE     }, // covert-ops start with x2 ammo
				{ WP_FG42,                 SK_LIGHT_WEAPONS,                            0, 40,  20,  INV_NONE     },
			...
			{
				{ WP_SMOKE_BOMB,           SK_MILITARY_INTELLIGENCE_AND_SCOPED_WEAPONS, 0, 0,   1,   INV_NONE     },
				{ WP_SATCHEL,              SK_MILITARY_INTELLIGENCE_AND_SCOPED_WEAPONS, 0, 0,   1,   INV_NONE     },
				{ WP_SATCHEL_DET,          SK_MILITARY_INTELLIGENCE_AND_SCOPED_WEAPONS, 0, 0,   0,   INV_NONE     },
				{ WP_BINOCULARS,           SK_BATTLE_SENSE,                             0, 0,   1,   INV_BINOCS   },
			},
			0,
			0,
	...
	{
		{
			...
			{ WP_KNIFE_KABAR,          SK_LIGHT_WEAPONS,                            0, 1,   0,   INV_NONE     },
			{
				{ WP_THOMPSON,             SK_LIGHT_WEAPONS,                            0, 60,  30,  INV_NONE     }, // soldier start with x2 ammo
				{ WP_MOBILE_BROWNING,      SK_HEAVY_WEAPONS,                            0, 0,   150, INV_NONE     },
				{ WP_FLAMETHROWER,         SK_HEAVY_WEAPONS,                            0, 200, 0,   INV_NONE     },
				{ WP_BAZOOKA,              SK_HEAVY_WEAPONS,                            0, 4,   0,   INV_NONE     },
				{ WP_MORTAR,               SK_HEAVY_WEAPONS,                            0, 15,  0,   INV_NONE     },
			},
			{
				{ WP_COLT,                 SK_LIGHT_WEAPONS,                            0, 24,  8,   INV_NONE     },
				{ WP_AKIMBO_COLT,          SK_LIGHT_WEAPONS,                            4, 48,  8,   INV_NONE     },
				{ WP_THOMPSON,             SK_HEAVY_WEAPONS,                            4, 60,  30,  INV_NONE     }, // soldier start with x2 ammo
			},
			{ WP_GRENADE_PINEAPPLE,    SK_LIGHT_WEAPONS,                            0, 4,   0,   INV_NONE     },
			{
				{ WP_BINOCULARS,           SK_BATTLE_SENSE,                             1, 1,   0,   INV_BINOCS   },
			},
			0,
...

		{
			...
			{ WP_KNIFE_KABAR,          SK_LIGHT_WEAPONS,                            0, 1,   0,   INV_NONE     },
			{
				{ WP_THOMPSON,             SK_LIGHT_WEAPONS,                            0, 0,   30,  INV_NONE     }, // medic start with 1 clip less
			},
			{
				{ WP_COLT,                 SK_LIGHT_WEAPONS,                            0, 24,  8,   INV_NONE     },
				{ WP_AKIMBO_COLT,          SK_LIGHT_WEAPONS,                            4, 48,  8,   INV_NONE     },
			},
			{ WP_GRENADE_PINEAPPLE,    SK_LIGHT_WEAPONS,                            0, 1,   0,   INV_NONE     },
			{
				{ WP_MEDIC_SYRINGE,        SK_FIRST_AID,                                0, 10,  1,   INV_NONE     },
				{ WP_MEDIC_ADRENALINE,     SK_FIRST_AID,                                4, 0,   1,   INV_NONE     }, // share ammo with medic syringe
				{ WP_MEDKIT,               SK_FIRST_AID,                                0, 0,   1,   INV_NONE     },
...

		{
			...
			{ WP_KNIFE_KABAR,          SK_LIGHT_WEAPONS,                            0, 1,   0,   INV_NONE     },
			{
				{ WP_THOMPSON,             SK_LIGHT_WEAPONS,                            0, 30,  30,  INV_NONE     },
				{ WP_CARBINE,              SK_LIGHT_WEAPONS,                            0, 20,  10,  INV_NONE     },
			},
			{
				{ WP_COLT,                 SK_LIGHT_WEAPONS,                            0, 24,  8,   INV_NONE     },
				{ WP_AKIMBO_COLT,          SK_LIGHT_WEAPONS,                            4, 48,  8,   INV_NONE     },
			...
			{ WP_GRENADE_PINEAPPLE,    SK_LIGHT_WEAPONS,                            0, 4,   0,   INV_NONE     },
			{
				{ WP_M7,                   SK_EXPLOSIVES_AND_CONSTRUCTION,              0, 4,   0,   INV_NONE     }, // riflenade as special weapon
				{ WP_DYNAMITE,             SK_EXPLOSIVES_AND_CONSTRUCTION,              0, 0,   1,   INV_NONE     },
				{ WP_PLIERS,               SK_EXPLOSIVES_AND_CONSTRUCTION,              0, 0,   1,   INV_NONE     },
				{ WP_LANDMINE,             SK_EXPLOSIVES_AND_CONSTRUCTION,              0, 0,   1,   INV_NONE     },
				{ WP_BINOCULARS,           SK_BATTLE_SENSE,                             1, 1,   0,   INV_BINOCS   },
...

		{
			...
			{ WP_KNIFE_KABAR,          SK_LIGHT_WEAPONS,                            0, 1,   0,   INV_NONE     },
			{
				{ WP_STEN,                 SK_LIGHT_WEAPONS,                            0, 64,  32,  INV_NONE     }, // covert-ops start with x2 ammo
				{ WP_FG42,                 SK_LIGHT_WEAPONS,                            0, 40,  20,  INV_NONE     },
